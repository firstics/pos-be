...
func (_c *Logger_Error_Call) RunAndReturn(run func(string)) *Logger_Error_Call {
	_c.Call.Return(run)
	return _c
}
...
//   - msg string
func (_e *Logger_Expecter) Fatal(msg interface{}) *Logger_Fatal_Call {
	return &Logger_Fatal_Call{Call: _e.mock.On("Fatal", msg)}
}

func (_c *Logger_Fatal_Call) Run(run func(msg string)) *Logger_Fatal_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *Logger_Fatal_Call) RunAndReturn(run func(string)) *Logger_Fatal_Call {
	_c.Call.Return(run)
	return _c
}
